...
def initialize_model():
    ...
    if success:
        ...
        if qwen_generator.edit_pipe:
            return "✅ Qwen-Image Enhanced Generator loaded successfully! All modes ready."
        else:
    ...
    with gr.Blocks(
        ...
        **Features:** Text-to-Image • Image-to-Image • Inpainting • Super-Resolution
        ...
        with gr.Row():
            ...
            init_btn = gr.Button("🚀 Initialize Enhanced Generator", variant="primary", scale=1)
        ...
        with gr.Group():
            ...
            generation_mode = gr.Radio(
                choices=["Text-to-Image", "Image-to-Image", "Inpainting", "Super-Resolution"],
                value="Text-to-Image",
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                with gr.Group(visible=False) as mask_group:
                    ...
                    gr.Markdown("*Draw white areas where you want to generate new content*")
        ...
        generation_mode.change(
            ...
            outputs=[
                prompt_group, negative_prompt_input, language_choice, enhance_prompt_toggle,
                init_image_group, mask_group, strength_group, superres_group,
                dimensions_group, generation_group, superres_image_upload
            ]
        )
        ...
        img2img_btn.click(
            ...
            inputs=[
                prompt_input, negative_prompt_input, init_image_upload, strength_slider,
                width_slider, height_slider, steps_slider, cfg_slider, seed_input, 
                language_choice, enhance_prompt_toggle
            ],
            outputs=[result_image, result_message]
        )
        ...
        inpaint_btn.click(
            ...
            inputs=[
                prompt_input, negative_prompt_input, init_image_upload, mask_editor,
                width_slider, height_slider, steps_slider, cfg_slider, seed_input,
                language_choice, enhance_prompt_toggle
            ],
            outputs=[result_image, result_message]
